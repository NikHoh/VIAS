...
class DataManager:
    ...
    def __init__(self, **kwargs):
        ...
        if not hasattr(self, '_initialized'):
            ...
            self.dijkstra_paths_path = os.path.join(self.data_processing_path, "dijkstra_paths")
            if not os.path.exists(self.dijkstra_paths_path):
                os.makedirs(self.dijkstra_paths_path)
            self.merged_grid_graphs_path = os.path.join(self.data_processing_path, "grid_graphs")
            if not os.path.exists(self.merged_grid_graphs_path):
                os.makedirs(self.merged_grid_graphs_path)
            self.optimized_paths_path = os.path.join(self.data_output_path, "optimized_paths")
